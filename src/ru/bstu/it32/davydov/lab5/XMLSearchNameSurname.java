...
class XMLSearchNameSurname extends DefaultHandler {
    ...
    protected XMLSearchNameSurname() throws RuntimeException, SAXException {
        System.out.print("Имя: ");
        searchName = sin.nextLine();
        searchName = searchName.trim();
        System.out.print("Фамилия: ");
        searchSurname = sin.nextLine();
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if(qName.equals("pupil")) {
            try {
                if ((name.equals(searchName)) && (surname.equals(searchSurname))) {
                    founded = true;
